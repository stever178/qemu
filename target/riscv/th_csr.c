...
static RISCVException read_th_csr(CPURISCVState *env, int csrno,
                                   target_ulong *val)
{
    *val = 0;
    return RISCV_EXCP_NONE;
...
const RISCVCSR th_csr_list[] = {
    ...
    },
    {
        .csrno = CSR_TH_MHCR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mhcr", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCOR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mcor", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCCR2,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mccr2", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MHINT,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mhint", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MRVBR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mrvbr", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCOUNTERWEN,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mcounterwen", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCOUNTERINTEN,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mcounterinten", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCOUNTEROF,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mcounterof", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCINS,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mcins", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCINDEX,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mcindex", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCDATA0,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mcdata0", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MCDATA1,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mcdata1", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MSMPR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.msmpr", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_CPUID,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.cpuid", mmode, read_th_csr }
    },
    {
        .csrno = CSR_TH_MAPBADDR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.mapbaddr", mmode, read_th_csr }
    },
    {
    ...
    },
    {
        .csrno = CSR_TH_SHCR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shcr", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SCER2,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.scer2", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SCER,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.scer", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SCOUNTERINTEN,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.scounterinten", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SCOUNTEROF,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.scounterof", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SCYCLE,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.scycle", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER3,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter3", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER4,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter4", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER5,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter5", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER6,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter6", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER7,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter7", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER8,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter8", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER9,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter9", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER10,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter10", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER11,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter11", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER12,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter12", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER13,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter13", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER14,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter14", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER15,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter15", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER16,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter16", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER17,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter17", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER18,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter18", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER19,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter19", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER20,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter20", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER21,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter21", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER22,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter22", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER23,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter23", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER24,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter24", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER25,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter25", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER26,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter26", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER27,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter27", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER28,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter28", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER29,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter29", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER30,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter30", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SHPMCOUNTER31,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.shpmcounter31", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SMIR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.smir", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SMLO0,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.smlo0", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SMEH,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.smeh", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_SMCIR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.smcir", smode, read_th_csr }
    },
    {
        .csrno = CSR_TH_FXCR,
        .insertion_test = test_thead_mvendorid,
        .csr_ops = { "th.fxcr", any, read_th_csr }
    },
    { }
};
